...
// Convert_v1alpha6_VirtualMachineNetworkRouteSpec_To_v1alpha4_VirtualMachineNetworkRouteSpec drops
// Table, which does not exist in v1alpha4; it is preserved via MarshalData on ConvertFrom.
func Convert_v1alpha6_VirtualMachineNetworkRouteSpec_To_v1alpha4_VirtualMachineNetworkRouteSpec(
