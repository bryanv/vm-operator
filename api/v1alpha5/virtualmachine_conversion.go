...
// Convert_v1alpha6_VirtualMachineNetworkRouteSpec_To_v1alpha5_VirtualMachineNetworkRouteSpec drops
// Table, which does not exist in v1alpha5; it is preserved via MarshalData on ConvertFrom.
func Convert_v1alpha6_VirtualMachineNetworkRouteSpec_To_v1alpha5_VirtualMachineNetworkRouteSpec(
